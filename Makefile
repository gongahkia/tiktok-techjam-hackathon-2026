...
evaluate:
	@FACETFLOW_USE_OPENAI=0 FACETFLOW_SPARSE_ONLY=1 FACETFLOW_CACHE_DIR=$(CACHE_DIR) $(PYTHON) -m evaluator.local_evaluator --catalog $(CATALOG) --dataset data/public_set.jsonl --output reports/repro_evaluation.json
